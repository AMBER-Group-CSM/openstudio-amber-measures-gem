...
class AddEMPDMaterialPropertiesWPreDefinedTest < Minitest::Test
  # def setup
  # end
  ...
  def test_good_argument_values
    ...
    measure = AddEMPDMaterialPropertiesWPreDefined.new
    ...
    for setting in model.getMaterialPropertyMoisturePenetrationDepthSettingss
      print "Setting added for #{setting.materialName}\n"
    end
    # print "Settings Size: #{model.getMaterialPropertyMoisturePenetrationDepthSettingss}"
    assert_equal(true, model.getMaterialPropertyMoisturePenetrationDepthSettingss.size.to_i == 1)
